...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("تنصيب سـيـمـو ❤️", "https://t.me/F0_EX"),
                Button.url(
                    "مساعدة ❓",
                    "https://t.me/Z1ZZIZ",
                ),
        ...
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/F0_EX"),
            ],
            [
