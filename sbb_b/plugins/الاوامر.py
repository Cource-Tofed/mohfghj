...
async def hi(event):
    await edit_or_reply(
        event,
        "✰︎ هـذه قـائـمـة اوامـر سـورس سـيـمـو\n\n✰︎ { `.م1` } ↢ اوامـر الادمـن\n✰︎ { `.م2` } ↢ اوامـر المـجمـوعـهہ\n✰︎ { `.م3` } ↢ اوامـر التـرحـيـب\n✰︎ { `.م4` } ↢ اوامـر الـردود\n✰︎ { `.م5` } ↢ اوامـر الـتـرفـيـهہ\n✰︎ { `.م6` } ↢ اوامـر حـمـايـهہ الـخـاص\n✰︎ { `.م7` } ↢ اوامـر الإذاعهہ و الڪشف\n✰︎ { `.م8` } ↢ اوامـر الـبـوت\n✰︎ { `.م9` } ↢ اوامـر الـمـنـ؏ والـتـرجـمـهہ\n✰︎ {`.م10`} ↢ اوامر التلكراف و النطق\n✰︎ {`.م11`} ↢ اوامـر الـتـحـمـيل\n✰︎ {`.م12`} ↢ اوامـر التـكــرار\n✰︎ {`.م13`} ↢ اوامر الانتحال والتقليد\n✰︎ {`.م14`} ↢ اوامـر الـوقـتـي\n✰︎ {`.م15`} ↢ اوامر الـذاتيهہ والاضافهہ\n✰︎ {`.م16`} ↢ اوامـر الـبـروفايـل\n✰︎ {`.م17`} ↢ اوامـر الأكـسـتـرا\n✰︎ {`.م18`} ↢ الـتاك و الـملـفات\n✰︎ {`.م19`} ↢ اوامـر الـصـيـغ\n✰︎ {`.م20`} ↢ اوامـر الـــتــسلـيـة\n✰︎ {`.م21`} ↢ اوامـر الـــتـحـكـم\n✰︎ {`.م22`} ↢ اوامـر الحـمـايـة\n\n[.  𝐒𝐄𝐌𝐎 - 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒 ♛  .](https://t.me/F0_EX) ",
        link_preview=False,
    )
rehu = [
    "قلوبنا صنعت للخير لم تصنع للشر",
    "إن الله هو الغفور الرحيم",
    "شكرًا لتنصيبك سيمو العربي",
]
...
async def we(event):
    await edit_or_reply(
        event,
        "**[ .  𝐒𝐄𝐌𝐎 - 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒 ♛  .](t.me/F0_EX)**\n✦┅━╍━╍╍━━╍━━╍━┅✦\n\n• اوامـر الـــتـحـكـم تتيح لمستخدم اخر ان يستخدم اوامـر تنصيبك وهو غير منصب سيمو حيث سيصبح متحكم في اوامـر تنصيبك يرجى الانتباه من انه سيحصل على صلاحيات الاوامـر وقد يسبب خطورة لك اذا كنت لا تثق في المستخدم الذي اضفته. \n\n\n`.الـــتـحـكـم` تفعيل/تعطيل\n• تستخدم هذه الميزة لتفعيل/لتعطيل خاصية الـــتـحـكـم بأوامر تنصيبك للمستخدمين الذين أضفتهم في قائمة المتحكمين\n\n`.المتحكمين`\n• لعرض المستخدمين الذين اضفتهم الى قائمة المستخدمين المتحكمين\n\n`.اضف متحكم`\n• بالرد على المستخدم لأضافته متحكم في تنصيب سيمو الخاص بك\n\n`.ازالة متحكم`\n• بالرد على المستخدم لازالته من قائمة المتحكمين",
        link_preview=False,
    )
